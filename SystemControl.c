...
static inline void SC_EnableRunModeClockPWM(SC_PWMConfiguration_t* pt_PWMConfiguration ){

    (SC_RunModeClockPWM_Reg)->Register |=(1<< (pt_PWMConfiguration->ConfigPWMmoduleUsed) );

}

static inline void SC_DisableRunModeClockPWM(SC_PWMConfiguration_t* pt_PWMConfiguration){
